...
export const aboutData = {
    ...
    desc: " I am a full-stack developer with 2 years of experience in developing websites using MERN Technologies (i.e MongoDB, Express JS, React JS, Node JS). I have a strong grip on the development of complex UI and manageable code structures. My goal is to help my clients in developing their websites using React according to their requirements.",
    desc2: " I use React.js for frontend with manageable css framework( Material UI, BootStrap, Tailwind css, Ant Design) for state managment used( Recoil, Redux-toolkit ). I use Node.js + Express.js for backend with SQL (MySQL, Oracle, PostgreSQL) and No-SQL( MongoDB + Cassandra)."
...
export const ServiceData = [
    ...
    },
    {
        ...
        desc: 'Get creative UI/UX design for visually appealing, easy-to-use, and enjoyable user experience for website as well as mobile that meets the needs and expectations of the target audience.'
    },
